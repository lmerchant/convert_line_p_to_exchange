"""
  ...
  cruise report at:
  https://www.waterproperties.ca/linep/2018-001/documents/2018-001_cruise_report.pdf

  download and rename to 18LU20180218_cruise_report.pdf
...
def build_url(year,month):
    ...
    url = 'https://www.waterproperties.ca/linep/' + year + '-' + month + '/documents/' + year + '-' + month + '_cruise_report.pdf'
    return url


def save_cruise_report(url, expocode):

    # download cruise report year-month-cruise_report.pdf 
    # reaname to expocode_Cruise_Report.pdf

    output_file = ("./cruise_reports/{}_Cruise_Report.pdf").format(expocode)
...
def main():
    ...
    for cruise in cruise_list:
        ...
        save_cruise_report(url, cruise[2])
